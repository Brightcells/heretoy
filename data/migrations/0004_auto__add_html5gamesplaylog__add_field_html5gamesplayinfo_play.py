...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Html5GamesPlayLog'
        db.create_table(u'data_html5gamesplaylog', (
            ...
            ('h5game', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='h5game_play_log', null=True, to=orm['data.Html5GamesInfo'])),
        ))
        db.send_create_signal(u'data', ['Html5GamesPlayLog'])

        # Adding field 'Html5GamesPlayInfo.play'
        db.add_column(u'data_html5gamesplayinfo', 'play',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Html5GamesPlayLog'
        db.delete_table(u'data_html5gamesplaylog')

        # Deleting field 'Html5GamesPlayInfo.play'
        db.delete_column(u'data_html5gamesplayinfo', 'play')
