...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Html5GamesInfo.nail'
        db.add_column(u'data_html5gamesinfo', 'nail',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Html5GamesInfo.real_nail'
        db.add_column(u'data_html5gamesinfo', 'real_nail',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Html5GamesInfo.nail'
        db.delete_column(u'data_html5gamesinfo', 'nail')

        # Deleting field 'Html5GamesInfo.real_nail'
        db.delete_column(u'data_html5gamesinfo', 'real_nail')
