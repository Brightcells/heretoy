...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Html5GamesInfo.language'
        db.add_column(u'data_html5gamesinfo', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Html5GamesInfo.operate'
        db.add_column(u'data_html5gamesinfo', 'operate',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Html5GamesInfo.language'
        db.delete_column(u'data_html5gamesinfo', 'language')

        # Deleting field 'Html5GamesInfo.operate'
        db.delete_column(u'data_html5gamesinfo', 'operate')
