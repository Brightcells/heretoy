...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LunbotuInfo.share_url'
        db.add_column(u'data_lunbotuinfo', 'share_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LunbotuInfo.share_url'
        db.delete_column(u'data_lunbotuinfo', 'share_url')
