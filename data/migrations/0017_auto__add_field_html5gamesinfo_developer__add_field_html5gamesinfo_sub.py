...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Html5GamesInfo.developer'
        db.add_column(u'data_html5gamesinfo', 'developer',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Html5GamesInfo.submit_at'
        db.add_column(u'data_html5gamesinfo', 'submit_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Html5GamesInfo.audit'
        db.add_column(u'data_html5gamesinfo', 'audit',
                      self.gf('django.db.models.fields.CharField')(default='ing', max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Html5GamesInfo.reject_reason'
        db.add_column(u'data_html5gamesinfo', 'reject_reason',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Html5GamesInfo.developer'
        db.delete_column(u'data_html5gamesinfo', 'developer')

        # Deleting field 'Html5GamesInfo.submit_at'
        db.delete_column(u'data_html5gamesinfo', 'submit_at')

        # Deleting field 'Html5GamesInfo.audit'
        db.delete_column(u'data_html5gamesinfo', 'audit')

        # Deleting field 'Html5GamesInfo.reject_reason'
        db.delete_column(u'data_html5gamesinfo', 'reject_reason')
    ...
    models = {
        ...
        u'data.html5gamesinfo': {
            ...
            'audit': ('django.db.models.fields.CharField', [], {'default': "'ing'", 'max_length': '255', 'null': 'True', 'blank': 'True'}),
