...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Html5GamesNailLog'
        db.create_table(u'data_html5gamesnaillog', (
            ...
            ('h5game', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='h5game_nail_log', null=True, to=orm['data.Html5GamesInfo'])),
            ('nail', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'data', ['Html5GamesNailLog'])

        # Adding field 'Html5GamesPlayInfo.nail'
        db.add_column(u'data_html5gamesplayinfo', 'nail',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Html5GamesNailLog'
        db.delete_table(u'data_html5gamesnaillog')

        # Deleting field 'Html5GamesPlayInfo.nail'
        db.delete_column(u'data_html5gamesplayinfo', 'nail')
