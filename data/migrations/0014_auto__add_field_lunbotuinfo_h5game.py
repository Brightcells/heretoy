...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LunbotuInfo.h5game'
        db.add_column(u'data_lunbotuinfo', 'h5game',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='h5game_lubotugame', null=True, to=orm['data.Html5GamesInfo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LunbotuInfo.h5game'
        db.delete_column(u'data_lunbotuinfo', 'h5game_id')
