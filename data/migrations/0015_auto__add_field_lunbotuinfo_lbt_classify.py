...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LunbotuInfo.lbt_classify'
        db.add_column(u'data_lunbotuinfo', 'lbt_classify',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LunbotuInfo.lbt_classify'
        db.delete_column(u'data_lunbotuinfo', 'lbt_classify')
