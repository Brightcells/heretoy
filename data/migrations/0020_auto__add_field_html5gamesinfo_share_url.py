...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Html5GamesInfo.share_url'
        db.add_column(u'data_html5gamesinfo', 'share_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Html5GamesInfo.share_url'
        db.delete_column(u'data_html5gamesinfo', 'share_url')
