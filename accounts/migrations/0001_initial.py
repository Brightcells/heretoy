...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_developer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='developer', unique=True, to=orm['accounts.Profile'])),
            ('devtype', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('com_tem_per', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ...
        db.send_create_signal(u'accounts', ['Developer'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'accounts_developer')


    models = {
        u'accounts.developer': {
            'Meta': {'object_name': 'Developer'},
            'com_tem_per': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'devtype': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'developer'", 'unique': 'True', 'to': u"orm['accounts.Profile']"})
        },
        u'accounts.profile': {
